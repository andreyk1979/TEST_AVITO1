...
async function addNewUser() {
	...
	await fetch("/registration", {
		...
		if (response.ok) {
			...
			addUserForm.find('#signup-email').val('');
			addUserForm.find('#signup-password').val('');
			addUserForm.find('#second-password').val('');
			addUserForm.find('#signup-birthday').val('');
...
function isPasswordMatch() {
	...
	if (password != confirmPassword) $("#divCheckPassword").html("Пароли не совпадают");
	else $("#divCheckPassword").html("Пароли совпадают");
}

$(document).ready(function () {
	$("#second-password").keyup(isPasswordMatch);
});
$('#hulk').prop('disabled' , true);
$('#second-password').on('keyup', function () {
	var password = $("#signup-password").val();
	var confirmPassword = $("#second-password").val();
